...
namespace TargetLex
{
    ...
    {
        [Option('o', "output-file", Required = false, HelpText = "Output file name, without extension unless you want to include one.")]
        ...
        [Option("check-password", Required = false, HelpText = "Check whether a password is directly generated by the selected TargetLex patterns.")]
